...
import { BookOpen, ArrowRight, Layers, LogOut, GraduationCap, ChevronDown, Filter, User, Menu, X } from 'lucide-react';
                    ...
                    <div className="flex items-center justify-between py-4">
                        ...
                        <div className="hidden md:flex items-center gap-2 lg:gap-4">
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-3 py-2 text-sm text-emerald-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all duration-200"
                            >
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-3 py-2 text-sm text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all duration-200"
                            >
                                <User size={16} />
                                My Account
                            </button>
                    ...
                    {isMobileMenuOpen && (
                        <div className="md:hidden pb-4 pt-2 border-t border-slate-800/80 space-y-2">
                            ...
                            <button
                                ...
                                className="flex w-full items-center gap-3 px-3 py-2.5 text-sm text-emerald-300 hover:text-white hover:bg-slate-800/50 rounded-xl transition-all duration-200"
                            >
                                Semester Registration
                            </button>
                            <button
                                onClick={() => {
                                    router.push('/student/gradesheets');
                                    setIsMobileMenuOpen(false);
                                }}
